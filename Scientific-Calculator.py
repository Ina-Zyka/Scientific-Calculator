...
class Pycalc(Frame):
    ...
    def createWidgets(self):
        # setting up Entry's
        self.prevAns = Entry(self, font=("Calibri", 14), relief=RAISED, justify=RIGHT, foreground='#e8e8e8',
                             borderwidth=0, background='#aaaaaa')
        self.prevAns.insert(0,"")
        self.prevAns.grid(row=0, column=0, columnspan=5, sticky="nsew")
        self.display = Entry(self, font=("Calibri", 24), relief=RAISED, justify=RIGHT, background='#aaaaaa',
                             foreground='#e8e8e8', borderwidth=0)
        self.display.insert(0, "0")
        self.display.grid(row=1, column=0, columnspan=5, sticky="nsew")
        # First row of buttons
        self.sinButton = Button(self, font=("Courier New", 14), foreground='#e8e8e8', text="sinx", borderwidth=1,
        ...
        self.cosButton = Button(self, font=("Courier New", 14), foreground='#e8e8e8', text="cosx", borderwidth=1,
        ...
        self.tanButton = Button(self, font=("Courier New", 14), foreground='#e8e8e8', text="tanx", borderwidth=1,
        ...
        self.logButton = Button(self, font=("Courier New", 14), foreground='#e8e8e8', text="logx", borderwidth=1,
        ...
        self.piButton = Button(self, font=("Courier New", 14), foreground='#e8e8e8', text="π", borderwidth=1,
        ...
        self.sinButton = Button(self, font=("Courier New", 14), foreground='#e8e8e8', text="√x", borderwidth=1,
        ...
        self.piButton = Button(self, font=("Courier New", 14), foreground='#e8e8e8', text="^", borderwidth=1,
                               background='#FF9933', activebackground='#a8a8a8', command=lambda: self.addToDisplay("**("))
        ...
        self.factButton = Button(self, font=("Courier New", 14), foreground='#e8e8e8', text="n!", borderwidth=1,
        ...
        self.equalsButton = Button(self, font=("Courier New", 14), foreground='#e8e8e8', text="=", borderwidth=1,
                               background='#FF9933', activebackground='#a8a8a8', command=lambda: self.evalDisplay())
